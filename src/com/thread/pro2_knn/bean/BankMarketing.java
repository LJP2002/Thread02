...
public class BankMarketing extends Sample{
	...
	public String toString() {
		return "BankMarketing{" +
				"age=" + age +
				", jobAdmin=" + jobAdmin +
				", jobBlueCollar=" + jobBlueCollar +
				", jobEntrepreneur=" + jobEntrepreneur +
				", jobHousemaid=" + jobHousemaid +
				", jobManagement=" + jobManagement +
				", jobRetired=" + jobRetired +
				", jobSelfEmployed=" + jobSelfEmployed +
				", jobServices=" + jobServices +
				", jobStudent=" + jobStudent +
				", jobTechnician=" + jobTechnician +
				", jobUnemployed=" + jobUnemployed +
				", jobUnknown=" + jobUnknown +
				", maritalDivorced=" + maritalDivorced +
				", maritalMarried=" + maritalMarried +
				", maritalSingle=" + maritalSingle +
				", maritalUnknown=" + maritalUnknown +
				", educationBasic4y=" + educationBasic4y +
				", educationBasic6y=" + educationBasic6y +
				", educationBasic9y=" + educationBasic9y +
				", educationHighSchool=" + educationHighSchool +
				", educationIlliterate=" + educationIlliterate +
				", educationProfessionalCourse=" + educationProfessionalCourse +
				", educationUniversityDegree=" + educationUniversityDegree +
				", educationUnknown=" + educationUnknown +
				", creditNo=" + creditNo +
				", creditYes=" + creditYes +
				", creditUnknown=" + creditUnknown +
				", housingNo=" + housingNo +
				", housingYes=" + housingYes +
				", housingUnknown=" + housingUnknown +
				", loanNo=" + loanNo +
				", loanYes=" + loanYes +
				", loanUnknown=" + loanUnknown +
				", contactCellular=" + contactCellular +
				", contactTelephone=" + contactTelephone +
				", contactJan=" + contactJan +
				", contactFeb=" + contactFeb +
				", contactMar=" + contactMar +
				", contactApr=" + contactApr +
				", contactMay=" + contactMay +
				", contactJun=" + contactJun +
				", contactJul=" + contactJul +
				", contactAug=" + contactAug +
				", contactSep=" + contactSep +
				", contactOct=" + contactOct +
				", contactNov=" + contactNov +
				", contactDec=" + contactDec +
				", contactMon=" + contactMon +
				", contactTue=" + contactTue +
				", contactWed=" + contactWed +
				", contactThu=" + contactThu +
				", contactFri=" + contactFri +
				", duration=" + duration +
				", campaign=" + campaign +
				", pdays=" + pdays +
				", pdaysNever=" + pdaysNever +
				", previous=" + previous +
				", poutcomeFailure=" + poutcomeFailure +
				", poutcomeNonexistent=" + poutcomeNonexistent +
				", poutcomeSuccess=" + poutcomeSuccess +
